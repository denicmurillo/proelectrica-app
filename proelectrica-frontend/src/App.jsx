...
// =================================================================
const DashboardTab = ({ proyectos, vistaDashboard, setVistaDashboard }) => {
  ...
  const calcularMetricasPMO = () => {
    ...
    const talentoCont = {};
    const proyectosCercaVencimiento = [];
...
function App() {
  ...
  return (
    <Box sx={{ backgroundColor: '#f1f5f9', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {tabActual === 2 ? (
        <DashboardTab proyectos={proyectos} vistaDashboard={vistaDashboard} setVistaDashboard={setVistaDashboard} />
      ) : (
